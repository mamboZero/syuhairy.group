class DependentsController < ApplicationController
  ...
  private
    ...
    def dependent_params
      params.require(:dependent).permit(:name, :ic_num, :mail_add_1, :mail_add_2, :race, :religion, :marital_status, :profession, :height, :weight, :phone_number, :contribution_value, :agent_id)
    end
end
